...
import type { AgentModelOAuthCredential, AgentRuntime } from "@engaz/adapter-kit";
import {
...
import { findDefaultModelCredential, findModelCredential, type PrismaClient } from "@engaz/db";
