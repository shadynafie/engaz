export const ZH_MESSAGES: Record<string, string> = {
  ...
  "Enter your Engaz server address.": "输入你的 Engaz 服务器地址。",
  "Show less": "收起",
  Members: "成员",
  Max: "最高",
  Minimal: "最低",
  ...
  "Point this app at your self-hosted Engaz origin, the same HTTPS URL you open in a browser.":
    "将此应用指向你自托管的 Engaz 源站，地址与你在浏览器中打开的 HTTPS URL 相同。",
  Private: "私有",
  Providers: "提供商",
  ...
  "Show {label}": "显示 {label}",
  "Sign in": "登录",
  "Sign in to Engaz": "登录 Engaz",
  "Sign out": "退出登录",
  "Sign up": "注册",
  "Sign up for Engaz": "注册 Engaz",
  "Sign-in": "登录",
  "Sign-up": "注册",
  ...
  "That URL did not look like a Engaz server": "该地址看起来不是 Engaz 服务器",
  ...
  "Paste the OpenAI-compatible address from your server. Engaz adds /v1 if needed.":
    "粘贴你服务器的 OpenAI 兼容地址。如有需要，Engaz 会自动补上 /v1。",
  Paused: "已暂停",
  Prompt: "提示词",
  ...
  "This subscription sign-in is not available in Engaz yet. Use a deployment credential or choose another provider.":
    "Engaz 暂不支持此订阅登录。请使用部署凭据或选择其他提供商。",
  "Tool sources": "工具源",
  Tools: "工具",
  Uninstall: "卸载",
  ...
  "1 needs attention": "1 个需要处理",
  "Access token (optional)": "访问令牌（可选）",
  "Add a name.": "请添加名称。",
  "Add server": "添加服务器",
  "Add the server address.": "请添加服务器地址。",
  Agents: "Agent",
  "Agents that can use it": "可以使用它的 Agent",
  "Check again": "重新检查",
  "Connect tools from a server on the internet or your network":
    "连接来自互联网或你的网络中服务器的工具",
  "Could not add MCP server": "无法添加 MCP 服务器",
  "Could not check this server": "无法检查此服务器",
  "Could not delete MCP server": "无法删除 MCP 服务器",
  "Could not load MCP servers": "无法加载 MCP 服务器",
  "Could not save the access token": "无法保存访问令牌",
  "Could not update agent access": "无法更新 Agent 权限",
  "MCP servers": "MCP 服务器",
  "New access token": "新的访问令牌",
  "No agent uses it yet": "还没有 Agent 使用它",
  "Not checked yet": "尚未检查",
  "Server address": "服务器地址",
  "Sign in needed": "需要登录",
  "Used by {names}": "使用者：{names}",
  "Working · 1 tool": "正常 · 1 个工具",
  "Working · {count} tools": "正常 · {count} 个工具",
  "e.g. Files": "例如：文件",
  "{count} need attention": "{count} 个需要处理",
  "{count} working": "{count} 个正常",
  "A skill with that name already exists.": "已存在同名技能。",
  Close: "关闭",
  ...
  Skills: "技能",
  Taught: "已教授",
  "This agent has no skills yet.": "此智能体还没有技能。",
  "When to use": "何时使用",
};
