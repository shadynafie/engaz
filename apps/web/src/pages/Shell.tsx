  ...
  const shell = (
    ...
    >
      ...
      <aside
        ...
        className={`absolute inset-y-0 end-0 z-30 flex min-h-0 shrink-0 flex-col overflow-hidden bg-background transition-[width] duration-150 ease-out md:relative ${
