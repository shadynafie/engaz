...
Current status: **0 verified; 1 in progress (1.1 and 1.2 verified; 1.3–1.4 planned, after phase 2); 2 in progress (2.1 and 2.2 verified); 3 in progress (3.2 and 3.4 verified); 4–5 planned.** Phase 2 moved ahead of 1.3–1.4 so the first-run experience is right before lifecycle tooling. Each numbered task should be a small reviewable PR with the stated proof. Finish a phase gate before calling that phase shipped. Parallel design, security, and data reviews can run while implementation proceeds; keep file ownership distinct.
