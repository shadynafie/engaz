import type { AdapterContext, ManagedConnectorProvider } from "@engaz/adapter-kit";
import { SecretAskPurpose } from "@engaz/contracts";
import type { PrismaClient, RunSecretWriter } from "@engaz/db";
